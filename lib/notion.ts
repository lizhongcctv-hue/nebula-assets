...
export const FALLBACK_ASSETS: Asset[] = [
  ...
  // 花卉微距 ×2
  { id: 'm001', name: '粉紫光影', category: '花卉微距', resolution: '4K', downloadUrl: 'https://www.pexels.com/search/videos/abstract-light/', isPremium: true, cover: 'pink_purple.jpg', tags: ['花卉', '微距'], description: '梦幻粉紫色光影背景' },
  { id: 'm002', name: '天台日落', category: '花卉微距', resolution: '4K', downloadUrl: 'https://www.pexels.com/search/videos/city-sunset/', isPremium: true, cover: 'rooftop.jpg', tags: ['花卉', '微距'], description: '天台视角的城市日落' },
  // AI人物 ×1
  { id: 'a001', name: '🏯 AI人物', category: 'AI人物', resolution: '4K', downloadUrl: 'https://www.pexels.com/search/videos/portrait/', isPremium: true, cover: 'face-closeup.jpg', tags: ['AI', '人像'], description: 'AI生成的高清人像' },
  // 古风意境 ×1
